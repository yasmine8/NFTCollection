...
contract NFT is ERC721A, Ownable {
    ...
    uint public saleStartTime = 1686753036;
    ...
    constructor() ERC721A("Yasmine", "YAS") {}
    ...
    **/
    ...
    // This will pay a contrebuter 3% of the initial sal to support his Youtube Channel
    // (bool hs, ) = payable(0x06f....111).call{value: address(this).balance * 3 / 100}("");
    // require(hs);
